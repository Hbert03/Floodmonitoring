...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body" style="border-radius:200px">
      <h4 style="color:black; font-family:'Bookman Old Style', Georgia, serif;" class="login-box-msg"><b><i>Flood Alert and Monitoring System</i></b></h4>
      <div class="text-center">
        <img src="img/logo.png" style="width:80%; position:relatives; border-radius:10px; margin-bottom:1em">
      </div>
